...
public interface ConfigExtensions<T> {
	...
	/**
	 * Can be used to validate your config fields after they have been edited in the config screen. Remember that this
	 * function is only called when the user is using a config screen - if they are editing the file directly they are on
	 * their own.
	 *
	 * @return A list of the errors and warnings that occurred during validation.
	 * @implNote It is worth calling {@code super.getValidationErrors()} and adding your own errors to the list, since by default
	 * this method performs validation such as adding warnings when the field is marked with {@link RequiresRestart}.
	 */
	...
	/**
	 * A link within your config screen. Displayed in the top right corner.
	 * Icons are displayed as 16x16 textures in 20x20 buttons.
	 *
